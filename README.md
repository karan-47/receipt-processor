...
This project uses FastAPI to handle API endpoints for processing receipts and calculating points. Data storage is managed using a Python dictionary, which can be found in `storage.py`.

## Architecture

The application follows a Model-Controller architecture with two models:
